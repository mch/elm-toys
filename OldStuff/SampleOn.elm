...
view model =
    div []
        [ p [] [ text ("Num spaces: " ++ (toString model.numSpaces)) ]
...
sampledInputs =
    Signal.sampleOn spaceSignal (Signal.map Enter enterSignal)
...
sampledInputs2 =
    Signal.sampleOn spaceSignal inputs
...
sampledInputs3 =
    Signal.sampleOn shiftSignal inputs


main =
    Signal.map view (Signal.foldp update init sampledInputs3)
